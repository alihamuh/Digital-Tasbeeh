...
import static com.alihamuh.ali.tasbeeh.Activity.testActivity2.ITEM;
...
public class testActivity extends baseActivity {
    ...
    public void setArraylistforAzkar(){
        ...
        int numberofZikrs=113;

        for(int counter=14;counter<=numberofZikrs; counter++){

            CompleteZikr instanceZikr =new CompleteZikr();

            //instanceZikr.setZikrType(selectZikrType("zikr_",counter));

            int totalZikrDone=settings.getInt("zikr_counter_key_"+counter, 0);

            instanceZikr.setZikrCounter(totalZikrDone);

            instanceZikr.setZikrText(selectZikrText("Zikr_",counter));
